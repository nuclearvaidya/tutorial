When instead of Gamma Radiation the energy is transferred to an orbital electron from preferably K or L Shell then it is emitted as an conversion electron.
